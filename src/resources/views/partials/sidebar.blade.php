    ...
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
              ...
              <li class="active"><a href="{{ route('home') }}"><i class="fa fa-book"></i>{{ trans('sidebar.question')}}</a></li>
              <li class="active"><a href="{{ route('home') }}"><i class="fa fa-exchange"></i>{{ trans('sidebar.exam')}}</a></li>
              <li class="active"><a href="{{ route('home') }}"><i class="fa fa-file"></i>{{ trans('sidebar.exam_paper')}}</a></li>
